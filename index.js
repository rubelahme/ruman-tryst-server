...
async function run() {
  try {
    const userCollection = client.db("ruman").collection("RumanTryst");
    const userCollections = client.db("ruman").collection("RumanTrystServer");
...
app.get("/", (req, res) => {
  res.send("Helle from Tryst Ruman");
});
